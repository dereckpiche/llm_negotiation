...
class TrustAndSplitRPSAgent(NegotiationAgent):
    def __init__(
        ...
        **kwargs,
        ...
        self.new_round_prompt = "In this round, your hand is {hand}."
        self.last_round_prompt = "Last round, your hand was {last_hand_agent}, and {other_agent}'s hand was {last_hand_coagent}. Based on these hands, your value per coin was {last_value_agent}, while {other_agent}'s value per coin was {last_value_coagent}.\nYou proposed {last_split_agent} coins and earned {last_points_agent} points, while {other_agent} proposed {last_split_coagent} coins and earned {last_points_coagent} points."
