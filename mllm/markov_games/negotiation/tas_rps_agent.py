    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.intro_prompt = (
            ...
            "3. Each round, both agents are randomly assigned a rock, paper or scissors hand so that one hand beats the other (no ties).\n"
            "4. You can only see your own hand.\n"
            "5. Hands are not played against each other. They only determine per-coin value in that round:\n"
            "   - Winning and losing hands are determined knowing both the agents' hands and rock beats scissors, scissors beats paper, paper beats rock.\n"
            "   - Winning hand determines a per-coin value of 10.\n"
            "   - Losing hand determines a per-coin value of 1.\n"
            "   - Over many rounds both agents are equally likely to have winning and losing hands.\n"
            "\n"
            "Protocol:\n"
            ...
            "   - Use this chat to share information, proposals, or strategies.\n"
